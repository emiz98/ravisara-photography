...
class printGalleryController extends Controller
{
    /**
    ...
    {
        $images = printGallery::all();
        return view('admin/prints/showGallery',compact('images'));
    }
    ...
    public function create()
    {
        ...
        return view('admin/prints/createGallery',compact('category'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin/prints/showGallery',compact('images','id'));
    }
    ...
    {
        $image = printGallery::find($id);
        $category_id = $image->category_id;
        $imageName = $image->image;

        Storage::delete($imageName);
        printGallery::where('id',$id)->delete();
