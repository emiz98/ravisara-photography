        ...
        <div class="gx-wrapper">
            ...
            <div class="animated slideInUpTiny animation-duration-3">
                ...
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">Print List</h2>
                    <a href="{{ route('print_category.create') }}" class="gx-btn gx-btn-light-green"><span>Add
                            Print</span></a>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($category as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <p><a class="btn btn-info" href="{{ route('print_gallery.show', $item['id']) }}">Gallery</a></p>
                                                </td>
                                                <td>
                                                    <p><a class="btn btn-success" href="{{ route('print_category.edit', $item['id']) }}">Update</a></p>
                                                </td>
                                                <td>
                                                    <form id="delete-form-{{ $item->id }}"
                                                        action="{{ route('print_category.destroy', $item['id']) }}" method="POST"
                                                        style="display: none">
                                                        @csrf
                                                        {{ @method_field('DELETE') }}
                                                    </form>
