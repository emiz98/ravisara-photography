        ...
        <div class="gx-wrapper">
            ...
            <div class="animated slideInUpTiny animation-duration-3">
                ...
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    ...
                    <a href="{{ route('category.create') }}" class="gx-btn gx-btn-light-green"><span>Add
                            Category</span></a>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($category as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <p><a class="btn btn-info" href="{{ route('images.show', $item['id']) }}">Gallery</a></p>
                                                </td>
                                                <td>
                                                    <p><a class="btn btn-success" href="{{ route('category.edit', $item['id']) }}">Update</a></p>
                                                </td>
                                                <td>
